...
def run_suite():
    ...
    test_cases = [
        {
            "name": "1. SAFE: Official Google Notification",
            "payload": {
        ...
        {
            "name": "2. VETO: Visual Impersonation (g0ogle)",
            "payload": {
                "sender": "support@g0ogle.com",
        ...
        },
        {
            ...
            "payload": {
                ...
                "body": "You sent $800 to an unknown user. If you didn't do this, cancel now. http://45.153.34.93/bins/kblockd0",
                "ip": "192.168.1.1",
                "auth_results": "dkim=fail; spf=fail;"
            },
            "expected": "High Risk"
        ...
        {
            "name": "4. CEO Urgent Gift Card Request",
            "payload": {
                "sender": "ceo@yourcompany.com",
                "subject": "URGENT",
                "body": "I need you to buy 50 gift cards for a client immediately. Do not call me, I am in a meeting.",
                "ip": "45.33.22.11",
                "auth_results": "dkim=fail; spf=fail;"
            },
            "expected": "Suspicious"
        ...
        {
            "name": "5. MALICIOUS: Phishing Link with Generic Sender",
            "payload": {
                "sender": "verify@secure-update.net",
                "subject": "Urgent: Account Verification",
                "body": "Your account will be deleted in 24h. Verify here: http://45.153.34.93/bins/xfsaild_sda",
                "ip": "88.77.66.55",
                "auth_results": "dkim=pass; spf=pass;"
            },
            "expected": "High Risk"
        ...
        {
            "name": "6. INFRASTRUCTURE: IP-Based URL & Fake Domain",
            "payload": {
                "sender": "billing@unregistered-fake-domain-998877.xyz",
                "subject": "Invoice Overdue",
                "body": "Please find your overdue invoice here: http://61.0.82.176:43179/invoice",
                "ip": "185.130.5.200",
                "auth_results": "dkim=pass; spf=pass;" 
            },
            "expected": "Suspicious" 
